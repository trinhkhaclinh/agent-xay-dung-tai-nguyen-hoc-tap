# -*- coding: utf-8 -*-
"""Script to copy and rearrange Session 01 results into the output directory.
"""
import os
import shutil
import stat
...
SRC = os.path.join(ROOT, "vault", "Sessions", "Session 01 - Định hướng học tập, demo sản phẩm cuối môn")
DST = os.path.join(ROOT, "output", "Session 01 - Định hướng học tập, demo sản phẩm cuối môn")
...
def arrange_output():
    ...
    print("Session 01 rearrangement in output complete successfully!")
